...
class TaskModel(models.Model):
    ...
    )  # TODO: Change this to project member
...
class CommentModel(models.Model):
    task = models.ForeignKey(
        TaskModel, on_delete=models.CASCADE, related_name="comments"
    )
...
class TaskHistoryModel(models.Model):
    task = models.ForeignKey(
        TaskModel, on_delete=models.SET_NULL, null=True, related_name="history"
    )
    changed_by = models.ForeignKey(
        User, on_delete=models.SET_NULL, null=True, related_name="task_changes"
    )
